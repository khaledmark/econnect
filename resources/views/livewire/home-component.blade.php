    ...
    <section id="home" class="s-home page-hero target-section" data-parallax="scroll" data-image-src="images/hero-bg.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <h3>
                We build brands so please add your data to contact you sir
                </h3>
                ...
                @endif
    <form method="post" action="send-message" class="form-inline">
        @csrf
        ...
        <div class="form-group col-xs-3">
                ...
                <input id="email" class="form-control input-group-lg reg_name" type="email" name="email"
                       title="Enter email"
        ...
        <div class="form-group col-xs-3">
                ...
                <input id="phone" class="form-control input-group-lg reg_name" type="tel" name="phone"
...
{{-- <div class="form-group">
        <label for="birthday" class="col-xs-3 col-sm-2 control-label" method="post" action="create"> @csrf </label>
        <div class="col-xs-3">
        ...
        <ul class="home-social">
            ...
            <li>
                <a href="https://www.facebook.com/eslamnuten/"><i class="fab fa-facebook-f" aria-hidden="true"></i><span>Facebook</span></a>
            </li>
            <li>
            ...
            <li>
                <a href="#0"><i class="fab fa-youtube" aria-hidden="true"></i><span>Youtube</span></a>
            </li>
            <li>
                <a href="#0"><i class="fab fa-google" aria-hidden="true"></i><span>Google</span></a>
            </li>
        </ul> <!-- end home-social -->
    ...
    <section id="about" class="s-about target-section">
        ...
        <div class="row section-header bit-narrow" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-1">
                We are E-Connect, a design and branding agency with partners worldwide. We design thoughtful digital experiences
            ...
            <div class="masonry">
                        ...
                        <div class="item-folio__thumb">
                            <a href="{{asset('images/portfolio/gallery/g-shutterbug.jpg')}}" class="thumb-link" title="Shutterbug" data-size="1050x700">
                                <img src="{{asset('images/portfolio/lady-shutterbug.jpg')}}" 
                                     srcset="{{asset('images/portfolio/lady-shutterbug.jpg 1x, images/portfolio/lady-shutterbug@2x.jpg 2x')}}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-folio__thumb">
                            <a href="{{asset('images/portfolio/gallery/g-woodcraft.jpg')}}" class="thumb-link" title="Woodcraft" data-size="1050x700">
                                <img src="{{asset('images/portfolio/woodcraft.jpg')}}" 
                                     srcset="{{asset('images/portfolio/woodcraft.jpg 1x, images/portfolio/woodcraft@2x.jpg 2x')}}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-folio__thumb">
                            <a href="{{asset('images/portfolio/gallery/g-beetle.jpg')}}" class="thumb-link" title="The Beetle Car" data-size="1050x700">
                                <img src="{{asset('images/portfolio/the-beetle.jpg')}}"
                                     srcset="{{asset('images/portfolio/the-beetle.jpg 1x, images/portfolio/the-beetle@2x.jpg 2x')}}" alt="">
                            </a>
                        </div>
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <div class="item-folio__thumb">
                            <a href="{{asset('images/portfolio/gallery/g-salad.jpg')}}" class="thumb-link" title="Grow Green" data-size="1050x700">
                                <img src="{{asset('images/portfolio/salad.jpg')}}" 
                                     srcset="{{asset('images/portfolio/salad.jpg 1x, images/portfolio/salad@2x.jpg 2x')}}" alt="">
                            </a>
                        </div>
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <div class="item-folio__thumb">
                            <a href="{{asset('images/portfolio/gallery/g-lamp.jpg')}}" class="thumb-link" title="Guitarist" data-size="1050x700">
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <div class="item-folio__thumb">
                            <a href="{{asset('images/portfolio/gallery/g-fuji.jpg')}}" class="thumb-link" title="Palmeira" data-size="1050x700">
        ...
        <div class="row contact-main" data-aos="fade-up">
            <div class="col-full">
                <p class="contact-email">
                    <a href="mailto:#0">k.muhammed3601@gmail.com</a>
                </p>
                <p class="contact-address">
                وادي النيل بالمهندسين <br>
                مصر , الجيزة 
                </p>
                <p class="contact-numbers">
                +20 1009634583 &nbsp; +20 1558483331
                </p>

                <ul class="contact-social">
                    <li>
                        <a href="https://www.facebook.com/eslamnuten/"><i class="fab fa-facebook"></i></a>
                    </li>
                    <li>
